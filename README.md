...
- Analyzing and validating large mortgage loan datasets using SQL, Excel, SharePoint, and MS Access to support regulatory reporting and operational decision-making.
- Developing Power BI dashboards and reporting solutions to visualize KPIs, performance metrics, and business insights.
- Building ETL and data transformation workflows using Python, SQL, Airflow, Snowflake, and AWS through hands-on data engineering projects.
- Collaborating with cross-functional teams to improve data quality, automate processes, and support data governance initiatives.
...
[View my repositories](https://github.com/Guruvendra47?tab=repositories)
